...
import kotlinx.android.synthetic.main.tarjeta_individual.view.*

class LugarAdapter(listaLugares:ArrayList<Lugar1>, contexto:Context):RecyclerView.Adapter<LugarAdapter.ViewHolder>() {


    var listaLugares:ArrayList<Lugar1>?=null
    ...
    class ViewHolder(vistaIndividual:View):RecyclerView.ViewHolder(vistaIndividual) {
        ...
        init {
            imagenDeFondo = vistaIndividual.idlugares
            nombreDelLugar = vistaIndividual.tvnombrelugar
        }
